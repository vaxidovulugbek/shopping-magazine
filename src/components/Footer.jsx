              ...
              <div className="row">
                <div className="col-md-4 mb-5">
                  ...
                  <div className="d-flex flex-column justify-content-start">
                    <NavLink className="text-dark mb-2" to="/"><i className="fa fa-angle-right mr-2" />Home</NavLink>
                    <NavLink className="text-dark mb-2" to="/shop"><i className="fa fa-angle-right mr-2" />Our Shop</NavLink>
                    <NavLink className="text-dark mb-2" to="/datail"><i className="fa fa-angle-right mr-2" />Shop Detail</NavLink>
                    <NavLink className="text-dark mb-2" to="/cart"><i className="fa fa-angle-right mr-2" />Shopping Cart</NavLink>
                    <NavLink className="text-dark mb-2" to="/checkout"><i className="fa fa-angle-right mr-2" />Checkout</NavLink>
                    <NavLink className="text-dark"      to="/contact"><i className="fa fa-angle-right mr-2" />Contact Us</NavLink>
                  </div>
                </div>
                <div className="col-md-4 mb-5">
                  <h5 className="font-weight-bold text-dark mb-4">Quick Links</h5>
